...
(defun mel-font-lock ()
  (list `("//.*" . font-lock-comment-face)
        ...
        `(,(regexp-opt mel-types 'words) . font-lock-type-face)
        `(,(regexp-opt mel-constants 'words) . font-lock-constant-face)
        `(,(regexp-opt mel-keywords 'words) . font-lock-keyword-face)
